    ...
    <section className="wfc-foundation-section py-10 px-4 md:py-16 md:px-[5%] pb-16 md:pb-[8rem] max-w-[1600px] mx-auto">
      <div className="wfc-foundation-inner grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-10 md:gap-12 lg:gap-[100px] items-stretch">
        <div className="wfc-foundation-text-col">
          <h2 className="wfc-section-heading text-[clamp(2rem,3.5vw,3rem)] font-medium mb-6 md:mb-8 tracking-[-0.02em] text-black">Our Foundation</h2>
          <div className="wfc-founder-tag inline-flex py-2 px-[1.2rem] bg-accent/25 text-text-primary rounded-full font-normal text-[0.85rem] md:text-[0.9rem] mb-8 md:mb-10">
        ...
        <div className="wfc-foundation-image-col w-full h-[300px] sm:h-[400px] lg:h-full mt-4 lg:mt-0">
          <img 
